from BioInfoToolkit.Clustering import softKMeansClustering
import numpy as np
...
def solve(data: npt.NDArray, k: int, beta: float) -> OutputT:
    centers = softKMeansClustering(data, k, beta)
...
def solve_and_check(input_path: str) -> bool:
    ...
    data = [[float(v) for v in line.split()] for line in lines[2:]]
    data = np.array(data)

    result = solve(data, k, beta)
...
if __name__ == "__main__":
    ...
    path = f'{cwd}/rosalind_ba8d_1.txt'
